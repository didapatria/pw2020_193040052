            ...
            <form class="col s12" action="" method="POST">
              <div class="row mb-0">
                <div class="input-field col s12">
                  <input id="food_id" type="hidden" name="id" class="validate" placeholder=" " autofocus value="<?= $food['id']; ?>">
                </div>
              </div>
              <div class="row mb-0">
                <div class="input-field col s12">
              ...
              <div class="row mb-0">
                <div class="input-field col s12">
                  <input id="food_porsi" type="text" class="validate" name="porsi" placeholder=" " autofocus value="<?= $food['porsi']; ?>">
