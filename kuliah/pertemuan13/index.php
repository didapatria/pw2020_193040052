...
<body>
  <div class="container">
    <a href="logout.php" class="waves-effect waves-light btn-small">Logout</a>
    ...
    <form action="" method="POST">
      ...
      <button type="submit" name="cari" class="waves-effect waves-light btn-small tombol-cari">Cari!</button>
    </form>
    <br>
