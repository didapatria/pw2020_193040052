...
// konfigurasi
$halaman = 12;
$total = count(query("SELECT * FROM foods"));
$pages = ceil($total / $halaman);
$page = isset($_GET["halaman"]) ? (int) $_GET["halaman"] : 1;
$mulai = ($page > 1) ? ($page * $halaman) - $halaman : 0;
$foods = query("SELECT * FROM foods LIMIT $mulai, $halaman");
$no = $mulai + 1;
?>
  ...
  <div class="hero list">
      ...
      <nav>
        <div class="nav-wrapper">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <li>
              <a href="login.php" class="btn btn-small waves-effect waves-light">
    ...
    <div class="container">
      <div class="row">
        ...
        <form class="d-inline-block left-align col s4" method="POST">
          <div div class="input-search" style="margin-top: 30px;">
        ...
        <div class="col s12">
          ...
          <div class="row">
            <div class="col s12 center-align">
              <ul class="pagination">
                <?php if ($page > 1) : ?>
                  <li class="waves-effect"><a href="?halaman=<?= $page - 1; ?>"><i class="material-icons">chevron_left</i></a></li>
                <?php else : ?>
                  <li class="disabled"><a href="?halaman=<?= $page - 1; ?>"><i class="material-icons">chevron_left</i></a></li>
                <?php endif; ?>
                <?php for ($i = 1; $i <= $pages; $i++) { ?>
                  <?php if ($i == $page) : ?>
                    <li class="active"><a href="?halaman=<?= $i; ?>"><?php echo $i; ?></a></li>
                  <?php else : ?>
                    <li class="waves-effect"><a href="?halaman=<?= $i; ?>"><?php echo $i; ?></a></li>
                  <?php endif; ?>
                <?php } ?>
                <?php if ($page < $pages) : ?>
                  <li class="waves-effect"><a href="?halaman=<?= $page + 1; ?>"><i class="material-icons">chevron_right</i></a></li>
                <?php else : ?>
                  <li class="disabled"><a href="?halaman=<?= $page + 1; ?>"><i class="material-icons">chevron_right</i></a></li>
                <?php endif; ?>
              </ul>
            </div>
          </div>
