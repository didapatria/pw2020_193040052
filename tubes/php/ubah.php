        ...
        <div class="card-panel">
          <div class="row">
            <form class="col s12" action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-0">
                <div class="col s12">
                  <input type="hidden" name="foto_lama" value="<?= $food['foto']; ?>">
                  <label>Foto Masakan</label>
                  <div class="file-field input-field">
                    <div class="btn">
                      <span>File</span>
                      <input id="food_fotor" type="file" name="foto" class="validate foto" onchange="previewImage()">
                    </div>
                    <div class="file-path-wrapper">
                      <input id="food_foto" class="file-path validate" type="text" name="foto" placeholder="Upload one or more files" autocomplete="off">
                    </div>
                  </div>
                  <div class="">
                    <img src="../assets/img/galeri/<?= $food['foto']; ?>" height="250" class="img-preview">
                  </div>
                </div>
              </div>
